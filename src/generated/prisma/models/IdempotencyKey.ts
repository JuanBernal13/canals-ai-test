...
export type IdempotencyKeyWhereInput = {
  ...
  customerId?: Prisma.UuidFilter<"IdempotencyKey"> | string
...
export type IdempotencyKeyScalarWhereWithAggregatesInput = {
  ...
  customerId?: Prisma.UuidWithAggregatesFilter<"IdempotencyKey"> | string
...
export type IdempotencyKeyOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "customerId" | "fingerprint" | "status" | "response" | "createdAt" | "completedAt" | "expiresAt", ExtArgs["result"]["idempotencyKey"]>
...
export interface IdempotencyKeyFieldRefs {
  ...
  readonly customerId: Prisma.FieldRef<"IdempotencyKey", 'String'>
