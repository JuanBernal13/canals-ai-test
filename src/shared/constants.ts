...
export const ERROR_CODE = {
  ...
  PAYMENT_CONNECTION: 'PAYMENT_CONNECTION',
  PAYMENT_NOT_READY: 'PAYMENT_NOT_READY',
  INVALID_QUEUE_EVENT: 'INVALID_QUEUE_EVENT',
  UNSUPPORTED_QUEUE_EVENT: 'UNSUPPORTED_QUEUE_EVENT',
  INVALID_STORED_RESPONSE: 'INVALID_STORED_RESPONSE',
  ORDER_EVENT_CONFLICT: 'ORDER_EVENT_CONFLICT',
